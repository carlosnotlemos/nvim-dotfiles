# -*- encoding: utf-8 -*-
# stub: solargraph 0.52.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<jaro_winkler>.freeze, ["~> 1.6".freeze])
  ...
  s.add_runtime_dependency(%q<rbs>.freeze, ["~> 3.0".freeze])
  s.add_runtime_dependency(%q<reverse_markdown>.freeze, [">= 2.0".freeze, "< 4".freeze])
